...
Complete reference for using TransformerEncoder layers in Neural DSL.
...
TransformerEncoder(
  ...
  num_layers=6,             # Number of stacked layers (default: 1)
  activation="gelu",        # Activation function (default: "relu")
  use_attention_mask=true   # Enable attention masks (default: false)
)
```
...
### Pattern 4: Production Transformer
...
- **Full Transformer Documentation**: [transformer_architecture.md](transformer_architecture.md)
- **Transformer Attention**: [transformer_attention.md](transformer_attention.md)
- **Transformer Training**: [transformer_training.md](transformer_training.md)
- **Transformer Migration**: [transformer_migration.md](transformer_migration.md)
- **DSL Language Reference**: [dsl.md](dsl.md)
